...
%
% This proof provides global guarantees of safety and progress for local perception and planning.
%
% Sridhar: Probably not. The proof relies on the fact that the LiDAR range is pretty good and the tracks have minimum and maximum width.
% The proof relies on a \emph{stability} property of Voronoi diagrams.
%
...
%
% Instantianeous plan and instantaineous way point are not necessary for this discussion.
%
% An \emph{instantaneous plan} is a waypoint given to the pure-pursuit controller.
%
